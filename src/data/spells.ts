...
export const SRD_SPELLS: Spell[] = [
  ...
  },
  {
    ...
    targetType: 'single',
    effects: [{
      damage: { count: 1, die: 8, type: 'necrotic' },
  ...
  },
  {
    ...
    higherLevelScaling: { extraDicePerLevel: 1, levelsPerExtraDie: 2 },
    ritual: false,
    classes: ['cleric'],
  },
  {
  ...
  },
  {
    ...
    targetType: 'cylinder',
    effects: [
      { damage: { count: 2, die: 8, type: 'bludgeoning' }, savingThrow: { ability: 'dexterity', dc: 0 }, areaSize: 20 },
  ...
  },
  {
    ...
    targetType: 'single',
    effects: [{
      damage: { count: 0, die: 4, type: 'radiant', bonus: 20 },
      savingThrow: { ability: 'dexterity', dc: 0 },
    }],
    ritual: false,
    classes: ['cleric'],
  ...
  },
  {
    ...
    targetType: 'cylinder',
    effects: [
      { damage: { count: 4, die: 6, type: 'fire' }, savingThrow: { ability: 'dexterity', dc: 0 }, areaSize: 10 },
      { damage: { count: 4, die: 6, type: 'radiant' } },
    ],
    higherLevelScaling: { extraDicePerLevel: 1 },
    ritual: false,
    classes: ['cleric', 'paladin'],
  ...
  // ── Wizard Level 9 ──
  {
    ...
    targetType: 'sphere',
    effects: [
      { damage: { count: 20, die: 6, type: 'fire' }, savingThrow: { ability: 'dexterity', dc: 0 }, areaSize: 40 },
      { damage: { count: 20, die: 6, type: 'bludgeoning' } },
    ],
    ritual: false,
    classes: ['wizard', 'sorcerer'],
  },
  ...
  },
  {
    ...
    targetType: 'sphere',
    effects: [
      { damage: { count: 2, die: 6, type: 'cold' }, areaSize: 20 },
      { damage: { count: 2, die: 6, type: 'acid' }, savingThrow: { ability: 'dexterity', dc: 0 } },
    ],
    ritual: false,
    classes: ['warlock'],
  },
  ...
  },
  {
    ...
    targetType: 'sphere',
    effects: [
      { damage: { count: 5, die: 6, type: 'thunder' }, condition: 'prone', savingThrow: { ability: 'constitution', dc: 0 }, areaSize: 30 },
      { damage: { count: 5, die: 6, type: 'radiant' } },
    ],
    ritual: false,
    classes: ['paladin'],
  },
